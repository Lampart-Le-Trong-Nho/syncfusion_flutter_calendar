...
@immutable
class DraggingAppointmentWidget extends StatefulWidget {
  const DraggingAppointmentWidget(
      this.dragDetails,
      this.isRTL,
...
class _DraggingAppointmentState extends State<DraggingAppointmentWidget> {
